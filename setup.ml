...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2dbf18397f8dda8f6583aa216f561eae) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "decentmon.ml"})
            ];
     ...
     oasis_digest = Some "\243\021+\144J/\193\199\158\213\195e\202\163\2386";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
