...
let rec generate_compared_results_efficient (alpha:d_alphabet) (size_form:int) (size_trace:int) (bias:bool) =
  ...
  (meaningful, List.length traceNeededCent + 1 , List.length traceNeededMDeCent + 1, List.length traceNeededODecent + 1,ncent,nMDecent,nODecent,smesscent,smessdecent,smessodecent, nbProgCent, nbProgDecent, nbProgODecent, formula, trace)
